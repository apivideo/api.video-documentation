...
| ------------------- | --------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- | --------- |
| video               | **yes**   | \{id: string;live?: boolean; token?: string;} | `id`: id of the video to play, `token` (optional): secret video token, `live` (optional): true for live videos              |           |
...
| muted               | no        | boolean                                                            | video               | **yes**   | \{id: string;live?: boolean; token?: string;} | `id`: id of the video to play, `token` (optional): secret video token, `live` (optional): true for live videos              |           |                              | Chromeless mode: all controls are hidden                                                                                        | false     |
